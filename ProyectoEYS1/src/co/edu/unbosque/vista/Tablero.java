...
public class Tablero extends JPanel {
	...
	private int division_paneles1 = 8,division_paneles2 = 8;
	private int numero_de_paneles1 = 8,numero_de_paneles2 =8;
...
//		this.posicion_fichas();
	...
	public void posicion_fichas() {
		...
		else if (division_paneles1 == 10) {
			paneles[9][0].add(ficha_roja);
			paneles[9][0].add(ficha_v);
			paneles[9][0].add(ficha_azul);
			paneles[9][0].add(ficha_ro);
