...
public class Tablero_12x12 extends JPanel {
	...
	int division_paneles1 = 12  ,division_paneles2 = 12;
	int numero_de_paneles1 = 12 ,numero_de_paneles2 =12;
	...
	public Tablero_12x12() {
		...
		ficha_roja.setBounds(-10, 27, 40, 30);
		...
		ficha_azul.setBounds(20, 25, 40, 30);
		...
		paneles[11][0].add(ficha_roja);
		paneles[11][0].add(ficha_v);
		paneles[11][0].add(ficha_azul);
		paneles[11][0].add(ficha_ro);
